...
export default function SignUpPage() {
  ...
  const onSubmit = async (data: RegisterFormValues) => {
    try {
      // Validation ensures role is a valid UserRole (not empty string)
      // Type assertion is safe because zod validation ensures role is UserRole
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto lg:mx-0 w-full lg:flex-1 space-y-2.5 sm:space-y-3">
          ...
          <div>
            <input
              ...
              {...register('firstName')}
              className={`w-full px-4 py-2.5 sm:py-3 bg-[#2C303A] border rounded-3xl text-white placeholder-[#6C707B] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-sm sm:text-base ${
                errors.firstName ? 'border-red-500' : 'border-[#4A4E57] focus:border-[#2196F3]'
              }`}
            />
            {errors.firstName && (
          ...
          <div>
            <input
              ...
              {...register('lastName')}
              className={`w-full px-4 py-2.5 sm:py-3 bg-[#2C303A] border rounded-3xl text-white placeholder-[#6C707B] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-sm sm:text-base ${
                errors.lastName ? 'border-red-500' : 'border-[#4A4E57] focus:border-[#2196F3]'
              }`}
            />
            {errors.lastName && (
          ...
          <div>
            <input
              ...
              {...register('email')}
              className={`w-full px-4 py-2.5 sm:py-3 bg-[#2C303A] border rounded-3xl text-white placeholder-[#6C707B] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-sm sm:text-base ${
                errors.email ? 'border-red-500' : 'border-[#4A4E57] focus:border-[#2196F3]'
              }`}
            />
            {errors.email && (
          ...
          <div>
            <select
              {...register('role')}
              className={`w-full px-4 py-2.5 sm:py-3 bg-[#2C303A] border rounded-3xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-sm sm:text-base appearance-none cursor-pointer ${
                errors.role ? 'border-red-500' : 'border-[#4A4E57] focus:border-[#2196F3]'
              }`}
              style={{
          ...
          {showCompanyField && (
            <div className="overflow-hidden transition-all duration-300 ease-out">
              <input
                ...
                {...register('company')}
                className={`w-full px-4 py-2.5 sm:py-3 bg-[#2C303A] border rounded-3xl text-white placeholder-[#6C707B] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-sm sm:text-base ${
                  errors.company ? 'border-red-500' : 'border-[#4A4E57] focus:border-[#2196F3]'
                }`}
              />
              {errors.company && (
          ...
          <div className="relative">
            <input
              ...
              {...register('password')}
              className={`w-full px-4 py-2.5 sm:py-3 bg-[#2C303A] border rounded-3xl text-white placeholder-[#6C707B] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-sm sm:text-base pr-10 ${
                errors.password ? 'border-red-500' : 'border-[#4A4E57] focus:border-[#2196F3]'
              }`}
            />
            <button
              type="button"
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-2.5 sm:py-3 bg-[#2C303A] border rounded-3xl text-white placeholder-[#6C707B] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-sm sm:text-base pr-10 ${
                errors.confirmPassword ? 'border-red-500' : 'border-[#4A4E57] focus:border-[#2196F3]'
              }`}
            />
            <button
              type="button"
