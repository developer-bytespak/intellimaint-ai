  ...
  return (
    <div className="w-full h-full bg-[#1f2632] flex overflow-hidden max-w-full">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ease-in-out min-w-0 max-w-full overflow-hidden relative ${
        ...
        {!isMobile && (
          <div className={`fixed top-0 right-0 z-50 bg-[#1f2632] border-b border-[#2a3441] transition-all duration-300 ease-in-out ${
            ...
            <div className="relative flex items-center px-4 py-3">
              ...
              {!isSidebarOpen && (
                <Link href={ROUTES.SUBSCRIPTION} className="absolute left-1/2 -translate-x-1/2 bg-[#2a3441] text-white px-3 py-2 rounded-xl text-sm font-medium hover:bg-blue-500 hover:text-white transition-colors duration-200 flex items-center gap-2">
