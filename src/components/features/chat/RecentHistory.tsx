  ...
  return (
    <div className="h-full bg-[#0a0a0a] text-white flex flex-col">
      ...
      <div className="px-4 py-6 border-b border-[#2a2a2a]">
        <h1 className="text-2xl font-bold text-center text-white">Recent History</h1>
      </div>

      {/* Tabs */}
      <div className="flex px-4 py-4 border-b border-[#2a2a2a] gap-2">
        <button
      ...
      <div className="px-4 py-4">
        <div className="relative">
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-[#2a2a2a] text-white placeholder-gray-400 px-4 py-3 rounded-xl border-none outline-none focus:ring-2 focus:ring-blue-500"
          />
      ...
      <div className="flex-1 overflow-y-auto px-4">
                  ...
                  <div
                    ...
                    className={`p-3 rounded-xl cursor-pointer transition-all duration-200 ${
                      activeChat?.id === chat.id
                        ? 'bg-[#2a2a2a] border border-blue-500'
                        : 'hover:bg-[#2a2a2a]'
                    }`}
                  >
                ...
                <div key={`${group.month}-${group.year}`}>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {group.photos.map((photo) => (
                      <div key={photo.id} className="aspect-square bg-[#2a2a2a] rounded-xl overflow-hidden">
        ...
        {activeTab === 'documents' && (
          <div>
            ...
            <div className="space-y-2">
              {documents.map((doc) => (
                <div key={doc.id} className="p-3 bg-[#2a2a2a] rounded-xl">
