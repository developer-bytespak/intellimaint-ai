            ...
            <div className="flex items-center justify-between w-full max-w-full overflow-visible">
              ...
              <div className="hidden md:flex items-center gap-2 ml-auto relative">
                ...
                <div className="relative pin-dropdown">
                  ...
                  {/* Plus Dropdown Menu */}
                  {showPinMenu && (
                    <div className="absolute bottom-full right-0 mb-2 bg-[#1f2632] border border-[#3a4a5a] rounded-xl shadow-lg p-3 z-[100]">
                      <div className="flex items-center gap-3">
                        <button
                          type="button"
                          disabled={isSending}
                          className={`w-10 h-10 flex items-center justify-center hover:bg-[#3a4a5a] text-white rounded-lg transition-all duration-200 ${isSending ? 'opacity-50 cursor-not-allowed' : ''}`}
